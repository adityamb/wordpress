...
# Play ansiblw playbook
  provisioner "local-exec" {
     command = "ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -u ec2-user -i '${aws_instance.wordpressec2.id},' --private-key ${local.private_key_path} playbook_word.yml"
